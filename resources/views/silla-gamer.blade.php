...
<head>
    <title>Silla Gamer-Producto</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/sillagamerpp.jpg') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/sillagameroja.jpg') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/sillagamerverde.jpg') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/sillagamernegro.jpg') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Silla Gamer Technisport Elite Resistencia 150 Kg</h1>
                            ...
                            <h6>Descripcion:</h6>
                            <p>Sumérgete en el mundo del gaming con nuestra Silla Gamer de última generación, que combina comodidad y estilo para brindarte una experiencia única. 
                                Su diseño ergonómico se adapta a la forma de tu cuerpo, con soporte lumbar ajustable y reposacabezas acolchado para sesiones prolongadas sin sacrificar el confort.
                                 Con un estilo vanguardista, detalles de costura y acentos de color, esta silla no solo potencia tu rendimiento, sino que también añade un toque moderno a tu espacio de juego. </p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
