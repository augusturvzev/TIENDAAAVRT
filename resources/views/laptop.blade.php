                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Equipos portatiles de Ultima generacion</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/HP Omen.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('hP-Omen') }}" class="h3 text-decoration-none">Laptop HP Omen </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>15-EK1097NR Gaming</li>
                                    <li class="pt-2">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Laptop Dell G15 Gaming.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('dellG15') }}" class="h3 text-decoration-none">Laptop Dell G15 Gaming</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                ...
                                <p class="text-center mb-0">S/7.800.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Laptop Asus ZenBook Pro.png') }}">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single.html"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="card-body">
                                <a href="{{ route('asusBook') }}" class="h3 text-decoration-none">Laptop Asus ZenBook Pro</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Duo 15 UX582ZM</li>
                                    <li class="pt-2">
                                ...
                                <p class="text-center mb-0">S/16.300.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Laptop Acer Nitro.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('acerNitro') }}" class="h3 text-decoration-none">Laptop Acer Nitro </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>AN517-55 Gaming</li>
                                    <li class="pt-2">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Laptop MSI GF63.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('mSIGF63') }}" class="h3 text-decoration-none">Laptop MSI GF63</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li> THIN 12VF-CTO Gaming</li>
                                    <li class="pt-2">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Laptop Dell Alienware.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('dellAlien') }}" class="h3 text-decoration-none">Laptop Dell Alienware</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>X15 R2 Gaming</li>
                                    <li class="pt-2">
                                ...
                                <p class="text-center mb-0">S/20.200.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Apple MacBook Pro.png') }}">
                            ...
                            <div class="card-body">
                                <a href="{{ route('macBookP16') }}" class="h3 text-decoration-none">Apple MacBook Pro</a>
                              
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li> M1 Pro (10 núcleos)</li>
                                ...
                                <p class="text-center mb-0">S/23.600.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Apple MacBook Pro 16.png') }}">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single.html"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none">Apple MacBook Pro 16</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>M1 Pro (10 núcleos)</li>
                                    <li class="pt-2">
                                ...
                                <p class="text-center mb-0">S/.23.900.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/Apple MacBook Pro 160.png') }}">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single.html"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center mb-0">S/.25.100.00</p>
                            </div>
                        </div>
                    </div>
                </div>
