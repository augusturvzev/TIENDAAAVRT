        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/dell.jpg') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/delltood1.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/delltood2.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/delltood3.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">PC Todo en Uno Dell Inspiron 27-7710 Intel Core i7-1255U Hasta 4.7 GHz, RAM 16GB, Sólido SSD 512GB + HDD 1TB, Video 2 GB NVIDIA GeForce MX550, LED 27" Full HD Táctil, Windows 11 Home</h1>
                            <p class="h3 py-2">S/4900.00</p>
                            <p class="py-2">
                            ...
                            <p>
                                ...
                                ¡Sumérgete en una experiencia informática excepcional con el PC Todo en Uno Dell Inspiron 27-7710, una obra maestra de potencia y elegancia! Con un procesador 
                                Intel Core i7-1255U que alcanza velocidades impresionantes de hasta 4.7 GHz, este dispositivo está listo para conquistar cualquier desafío que le presentes, 
                                ya sea productividad, entretenimiento o creación de contenido.
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	Dell</li>
                                <li>Modelo	AIO Inspiron 27 Serie 7000 / 7710 / Dell Inspiron 27-7710 / Dell Inspiron 7710 AIO / Dell Inspiron 27 7710 All-in-One / NVIDIA MX550 / Táctil</li>
                                <li>Procesador	Intel® Core™ i7-1255U de 12.ª generación 12 MB de caché, 10 núcleos, 12 subprocesos, hasta 4,70 GHz Turbo</li>
                                <li>Memoria RAM	Memoria RAM 16 GB DDR4-3200 MHz ampliable</li>
                                <li>Disco Duro	Sólido SSD 512GB PCIe NVMe M.2 (unidad de arranque) + HDD 1TB 5400 RPM (almacenamiento)</li>
                                <li>Monitor	Táctil Full HD de 27" (1920 x 1080) con borde estrecho Infinity Edge antirreflectante</li>                   
                                <li>Tarjeta de video	NVIDIA® GeForce® MX550 con memoria gráfica GDDR6 de 2 GB dedicada</li>
                            </ul>
