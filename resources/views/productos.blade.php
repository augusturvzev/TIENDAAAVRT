                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Articulos de Limpieza</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/legia_01.jpg') }}">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ asset('media/ayudin.jpg') }}">
