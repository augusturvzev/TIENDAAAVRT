...
<head>
    <title>Servicios-Muebles de Melamina</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/mueblesamedidad2.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/armadoper.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/medidas.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/mueblesamedidad2.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Comercializacion y Fabricacion de muebles de Melamina</h1>
                             <p class="h3 py-2">S/00.00</p>
                            <p class="py-2"> 
                            ...
                            <h6>Descripcion:</h6>
                            <p>Nos especializamos en la Comercialización y Fabricación de muebles de Melamina, ofreciendo soluciones a medida que combinan funcionalidad y diseño moderno. Nos enorgullece transformar espacios a través de la calidad y la versatilidad de la melamina, un material duradero y estético.
                            Ofrecemos un enfoque personalizado en cada proyecto. Nuestro equipo de diseñadores trabaja estrechamente con nuestros clientes para crear muebles que se adapten perfectamente a sus necesidades y estilo de vida.        
                            Utilizamos las últimas tecnologías y técnicas de fabricación para garantizar la durabilidad y la precisión en cada mueble que producimos. Desde armarios hasta escritorios y estanterías, nos esforzamos por superar las expectativas en términos de calidad y acabado.
                        </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                ...
                                <li>Calidad en la Fabricación</li>
                                <li>Variedad de Estilos y Acabados</li>
                                <li>Entrega y Montaje Profesional</li>
