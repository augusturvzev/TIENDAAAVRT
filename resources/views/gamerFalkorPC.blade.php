        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/pc1.jpg') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/pc1-teclado.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/g203_1.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/pc1.jpg') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">PC Gamer Falkor RGB Ryzen 9 5900X</h1>
                            ...
                            <h6>Descripcion:</h6>
                            <p>La PC Gamer Falkor RGB con procesador Ryzen 9 5900X es una potente máquina diseñada para brindar un rendimiento excepcional en juegos y tareas intensivas. Aquí tienes los componentes del equipo. </p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Garantia:</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Un año</strong></p>
                                </li>
                            </ul>

                            <h6>Especificaciones Tecnicas:</h6>
                            <ul class="list-unstyled pb-3">
                                <li>AMD Ryzen 9 5900X 3.7GHz/4.8GHz
</li>
                                <li>12 núcleos, 24 hilos, 64MB caché L3</li>
                                <li>AM4, 105W</li>
                                <li>Disco Sólido SSD M.2 1TB NVMe</li>
                                <li>Memoria RAM 32GB DDR4 3200MHz</li>
                                <li>Tarjeta Madre X570</li>
                                <li>Tarjeta de Video RTX4060Ti 8GB</li>
                                <li>Monitor Curvo FHD 24" 75Hz</li>
                                <li>Fuente de Poder Certificada 850W 80PLUS GOLD</li>

                                <li>Teclado Mecánico Antryx + Mouse Logitech G203 6000DPI</li>
                                <li>Enfriamiento Líquido 240</li>
                                <li>CASE: 1st Player SP7</li>
