                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="{{ route('gamerFalkorPC') }}" class="h3 text-decoration-none">PC Gamer Falkor RGB</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="{{ route('dellInspiron') }}"class="h3 text-decoration-none">PC Todo en Uno Dell  </a>
