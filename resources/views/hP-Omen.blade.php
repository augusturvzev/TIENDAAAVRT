        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/HP Omen.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/hpOmen-3.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/hpOmen-2.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/hpOmen-1.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Laptop HP Omen 15-EK1097NR Gaming</h1>
                            <p class="h3 py-2">S/9000.00</p>
                            <p class="py-2">
                            ...
                            <h6>Descripcion:</h6>
                            <p>La HP Omen 15-EK1097NR Gaming presume un rendimiento excepcional gracias a su potente procesador Intel Core i7 o AMD Ryzen 7 de última generación. Estos procesadores,
                                 combinados con una arquitectura eficiente, ofrecen un rendimiento multitarea fluido y una capacidad de respuesta rápida, esencial para satisfacer las demandas de los 
                                 juegos y las tareas exigentes. </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	HP</li>
                                <li>Modelo	OMEN 15-ek1097Rnr / HP OMEN 15 Series / NVIDIA RTX 3060 / 450B9UAR / US</li>
                                <li>Procesador	Intel® Core™ i7-10870H 2.2 GHz hasta 5.0 GHz, 8 núcleos, 16 MB Intel® Smart Cache - Décima Generación.</li>
                                <li>Memoria RAM	16 GB de RAM DDR4-2933 MHz (2x8 GB) Admite hasta 32 GB de memoria máxima</li>
                                <li>Almacenamiento	Sólido SSD de 512GB PCIe® NVMe™ M.2</li>
                                <li>Pantalla	15.6" WLED Full HD (1920x1080), IPS, antirreflectante y microbordes, a 144Hz de refresco / 7ms, 72 % de NTSC, sRGB 100%</li>                   
                                <li>Batería	Polímero de iones de litio de 6 celdas y 70,9 Wh</li>
                            </ul>
