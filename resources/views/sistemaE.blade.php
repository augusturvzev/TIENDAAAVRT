...
<head>
    <title>Servicios-Instalaciones Electricas</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/teatro.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/teatro3.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/teatro4.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/teatro.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Mantenimiento Profesional de Instalaciones </h1>
                            ...
                            <h6>Descripcion:</h6>
                            <p>Somos una empresa líder en el sector de servicios eléctricos, especializada en el Mantenimiento Profesional para Instalaciones Eléctricas. Contamos con un equipo de técnicos altamente capacitados y certificados que se dedican a garantizar el óptimo rendimiento y la seguridad de las instalaciones eléctricas de nuestros clientes.
                                Nuestros servicios de mantenimiento abarcan desde inspecciones regulares hasta soluciones preventivas y correctivas. Realizamos revisiones exhaustivas de sistemas eléctricos, identificando posibles problemas, desgastes o fallas antes de que se conviertan en situaciones críticas. Esto no solo ayuda a evitar interrupciones no planificadas, 
                                sino que también prolonga la vida útil de los equipos. </p>
                            <!-- <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Pistón: Clase II</li>
                                <li>Material del relleno: Espuma de Poliuretano (PU)</li>
                                <li>Material del tapiz: Cuerina (Cuero PU)</li>
                                <li>Material de los apoyabrazos: Poliuretano (PU)</li>
                                <li>Material del soporte principal : Metal</li>
                                <li>Material de las puntas de la base: Cloruro de Polivinilo (PVC)</li>
                                <li>Material de las ruedas: Nylon</li>
                            </ul>
