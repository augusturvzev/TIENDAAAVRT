...
<head>
    <title>Laptop Asus ZenBook Pro</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/Laptop Asus ZenBook Pro.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/asus1.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/asus2.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/asus3.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Laptop Asus ZenBook Pro Duo </h1>
                            <p class="h3 py-2">S/16300.00</p>
                            <p class="py-2">
                            ...
                            <h6>Descripcion:</h6>
                            <p>La Laptop Asus ZenBook Pro Duo es verdaderamente una obra maestra de ingeniería, creada con precisión para satisfacer las demandas específicas de profesionales 
                                creativos y usuarios exigentes. En el núcleo de su diseño se encuentra una amalgama de tecnología avanzada y un enfoque centrado en el rendimiento, con el objetivo 
                                claro de ofrecer una experiencia de productividad y creatividad sin igual. </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	Asus</li>
                                <li>Modelo	Asus ZenBook Pro Duo UX582ZM Series / Asus ZenBook Pro Duo OLED 15 / Asus ROG ZenBook Pro Duo 15 / ScreenPad Plus 14" / i7 doceava</li>
                                <li>Procesador	Intel® Core™ i7-12700H (frecuencia de 3.5GHz hasta 4.7GHz, con 14 Núcleos, 24MB Caché) - Doceava generación.</li>
                                <li>Memoria RAM	16GB DDR5</li>
                                <li>Almacenamiento	SSD de rendimiento M.2 NVMe™ PCIe® 4.0 de 1 TB</li>
                                <li>Pantalla	OLED Táctil UHD 4K (3840 x 2160) de 15,6 " Bisel de 5 mm, gama de colores 100% DCI-P3, 133% sRGB, HDR True Black 500 / Pantalla secundaria ScreenPad Plus táctil 4K de 14 ”(3840 x 1100)</li>                   
                                <li>Batería	92 WHrs, 4S2P, iones de litio de 8 celdas</li>
                            </ul>
