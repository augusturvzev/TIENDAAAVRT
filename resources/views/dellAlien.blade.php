...
<head>
    <title>Laptop Dell Alienware X15 R2 Gaming</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/Laptop Dell Alienware.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellalien2.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellalien3.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellalien1.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Laptop Dell Alienware X15 R2 Gaming, Intel Core i7-12700H 3.5 GHz, RAM 32GB, Sólido SSD 1TB PCIe, Video 6 GB Nvidia RTX 3060, LED 15.6" Full HD a 165 Hz, Windows 11 Home </h1>
                            <p class="h3 py-2">S/20200.00</p>
                            <p class="py-2">
                        ...
                        La Laptop Dell Alienware X15 R2 Gaming redefine la experiencia de juego con una combinación imponente de potencia, rendimiento y diseño vanguardista. Diseñada 
                        específicamente para satisfacer las demandas de los jugadores más exigentes, esta máquina incorpora las últimas innovaciones tecnológicas para ofrecer una experiencia 
                        de juego inigualable. A continuación, desglosaremos detalladamente las características clave de esta impresionante laptop: </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	Dell</li>
                                <li>Modelo	Alienware X15 R2 / RTX-3060 / W11 Home  </li>
                                <li>Procesador	Intel® Core™ i7-12700H (14 Núcleos, 24MB Caché, 3.5 GHz hasta 4.7GHz) - Doceava generación.</li>
                                <li>Memoria RAM	32 GB de memoria DDR5 a 5200 MHz</li>
                                <li>Almacenamiento	Sólido 1TB PCIe M.2 SSD</li>
                                <li>Pantalla	de 15.6" Full HD (1920 x 1080) 300 nits, a 165 Hz, Antirreflejo, sRGB al 100%,G-SYNC, Optimus avanzado</li>                   
                                <li>Tarjeta de video	NVIDIA® GeForce RTX™ 3060 con memoria GDDR6 de 6 GB dedicados</li>
                                <li>	Batería	ION-Lithium 87 WHR</li>
                            </ul>
