...
<head>
    <title>Laptop Acer Nitro AN517-55 Gaming</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/Laptop Acer Nitro.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/ace1.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/ace2.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/ace3.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Laptop Acer Nitro AN517-55 Gaming </h1>
                            <p class="h3 py-2">S/9900.00</p>
                            <p class="py-2">
                            ...
                            <h6>Descripcion:</h6>
                            <p>La Laptop Acer Nitro 5 AN517-55 Gaming no es simplemente una herramienta, es una puerta de entrada a un mundo de experiencias de juego excepcionales y 
                                rendimiento informático de alto nivel. Diseñada con un enfoque intrépido y decidido, esta máquina se erige como un testimonio de la dedicación de Acer para 
                                proporcionar una plataforma gaming que no solo cumple con las expectativas, sino que las supera con creces. </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	Acer</li>
                                <li>Modelo	Acer Nitro AN517-55- Series / Laptop Gaming Acer Nitro AN517-55 / Core i7 / RTX 3060 / 144Hz</li>
                                <li>Procesador	Intel Core i7-12700H (14 Núcleos, 24MB Caché, 3.5GHz hasta 4.7GHz, 64-bit) - Doceava generación.</li>
                                <li>Memoria RAM	16 GB SDRAM DDR4-3200 ampliable</li>
                                <li>Almacenamiento	Sólido 1TB SSD M.2 2280 PCIe</li>
                                <li>Pantalla	Retroiluminación LED, Tipo de pantalla LCD, 17.3" Full HD (1920 x 1080),144Hz, Tecnología de conmutación en el plano (IPS) ComfyView</li>                   
                                <li>Tarjeta de video	NVIDIA® GeForce® RTX 3060 con memoria GDDR6 con 6 GB dedicados</li>
                                <li>Batería	Litio con 4 Celdas. 90 Wh. Tiempo máximo de funcionamiento de la batería 7 horas dependiendo condiciones</li>
                            </ul>
