...
<head>
    <title>Laptop Dell G15 Gaming</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('media/Laptop Dell G15 Gaming.png') }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellG15.png') }}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellG15-0.png') }}" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{ asset('media/dellG15-1.png') }}" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Laptop Dell G15 Gaming</h1>
                            <p class="h3 py-2">S/7800.00</p>
                            <p class="py-2">
                            ...
                            <h6>Descripcion:</h6>
                            <p>La Laptop Dell G15 Gaming está impulsada por un rendimiento excepcional gracias a su procesador Intel Core i7 o AMD Ryzen 7 de última generación. Estos procesadores, 
                                conocidos por su capacidad para manejar tareas intensivas, proporcionan una base sólida para el rendimiento multitarea y la ejecución eficiente de juegos exigentes.. </p>
                            <ul class="list-inline">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Marca	Dell</li>
                                <li>Modelo	Dell G15 Ryzen Edition Gaming / Portátil para juegos G15 Ryzen Edition / Dell G15 5515 / AMD Ryzen 7 / Nvidia RTX 3050 Ti</li>
                                <li>Procesador	AMD Ryzen 7 5800H frecuencia de 3.2GHz hasta 4.4GHz, 4MB Cache L2, 16MB Cache L3, 8 núcleos</li>
                                <li>Memoria RAM	16 GB DDR4-3200MHz ampliable</li>
                                <li>Almacenamiento	Sólido PCIe NVMe M.2 de 512 GB</li>
                                <li>Pantalla	de 15.6" Full HD (1920 x 1080), 120 Hz, 250 nits, WVA, antirreflectante, retroiluminación LED, borde estrecho</li>                   
                                <li>Tarjeta de video	NVIDIA GeForce RTX 3050 Ti, con 4 GB GDDR6 dedicados</li>
                                <li>Batería	3 Celdas 56 Whr Integrada</li>
                            </ul>
